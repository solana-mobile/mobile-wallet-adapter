...
export const NativeWalletName = 'Native' as WalletName<'Native'>;
...
export class NativeWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    get publicKey(): PublicKey | null {
        throw new Error('`publicKey` getter not implemented');
    }

    get connecting(): boolean {
        throw new Error('`connecting` getter not implemented');
    }
