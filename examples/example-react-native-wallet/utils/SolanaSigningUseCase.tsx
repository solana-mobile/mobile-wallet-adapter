...
export class SolanaSigningUseCase {
    ...
    static signTransaction(transactionByteArray: Uint8Array, keypair: Keypair): Uint8Array {
    ...
    static signMessage(messageByteArray: Uint8Array, keypair: Keypair): Uint8Array {
