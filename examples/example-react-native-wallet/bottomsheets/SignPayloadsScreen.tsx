...
const signTransactions = async (wallet: Keypair, request: SignTransactionsRequest) => {
...
export default function SignPayloadsScreen({ request }: SignPayloadsScreenProps) {
    ...
    const isSignTransactions = request.__type === MWARequestType.SignTransactionsRequest;
