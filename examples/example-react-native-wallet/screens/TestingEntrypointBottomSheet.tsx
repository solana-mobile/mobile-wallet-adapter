...
const SendResponseButton = (props: SendResponseButtonProps & SendResponseButtonTypedProps) => {
    const { title } = props;
    return (
        <TouchableOpacity
            style={styles.button}
...
export default function TestingEntrypointBottomSheet() {
    ...
    const signPayloadsResponse: SignMessagesResponse = {
        signedPayloads: [new Uint8Array([1, 2, 3]), new Uint8Array([1, 2, 3, 4, 5])],
    };

    const signAndSendTransactionsResponse: SignAndSendTransactionsResponse = {
        signedTransactions: [new Uint8Array([1, 2, 3]), new Uint8Array([1, 2, 3, 4, 5])],
    };
                ...
                <View style={styles.bottomSheet}>
                    ...
                    <SendResponseButton
                        request={{
                            ...
                            payloads: [new Uint8Array([1, 2, 3]), new Uint8Array([1, 2, 3, 4, 5])],
                        }}
                        requestType={MWARequestType.SignTransactionsRequest}
