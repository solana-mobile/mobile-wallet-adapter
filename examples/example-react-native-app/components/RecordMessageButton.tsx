...
export default function RecordMessageButton({ children, message }: Props) {
    ...
    const recordMessageGuarded = useGuardedCallback(
        async (messageToRecord: string): Promise<string> => {
        ...
        <>
                ...
                <Button
                    ...
                    onPress={async () => {
                        ...
                        try {
                            ...
                            setSnackbarProps({
                                children: 'Failed to record message:' + (err instanceof Error ? err.message : err),
                            });
            ...
            <Portal>
                ...
                >
                    <Dialog.Content>
                        <Paragraph>
                            Clicking &ldquo;Record&rdquo; will send a transaction that records the text you&apos;ve
                            written on the Solana blockchain using the Memo program.
                        </Paragraph>
                        <Dialog.Actions>
                            <Button
                                onPress={() => {
