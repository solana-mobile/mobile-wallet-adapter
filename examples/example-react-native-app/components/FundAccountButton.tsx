import { Address, airdropFactory, isSolanaError, lamports, SOLANA_ERROR__RPC__TRANSPORT_HTTP_ERROR } from '@solana/kit';
                ...
                try {
                    ...
                    if (signature) {
                        ...
                        mutate(
                            ...
                            (currentBalance?: number) => (currentBalance || 0) + Number(LAMPORTS_PER_AIRDROP),
                        );
                    }
                } catch (err) {
                    setSnackbarProps({
                        children: 'Failed to fund account: ' + (err instanceof Error ? err.message : err),
                    });
                } finally {
