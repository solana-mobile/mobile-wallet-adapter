...
public class ProtocolContract {
    ...
    // METHOD_REAUTHORIZE returns a RESULT_PUBLIC_KEY
    ...
    // METHOD_CLONE_AUTHORIZATION returns a RESULT_PUBLIC_KEY
    // METHOD_CLONE_AUTHORIZATION returns an optional RESULT_WALLET_URI_BASE
