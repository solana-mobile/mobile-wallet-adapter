...
public class SignOffchainMessagesRequest extends SignPayloadsRequest {
    /*package*/ SignOffchainMessagesRequest(@NonNull MobileWalletAdapterServer.SignOffchainMessagesRequest request,
