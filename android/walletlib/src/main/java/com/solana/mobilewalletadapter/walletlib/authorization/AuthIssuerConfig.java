...
public class AuthIssuerConfig {
    ...
    public static final long DEFAULT_REAUTHORIZATION_NOP_DUATION_MS = 10L * 60L * 1000L; // 10 minutes
    ...
    public AuthIssuerConfig(@NonNull String name) {
        this(name, DEFAULT_MAX_OUTSTANDING_TOKENS_PER_IDENTITY, DEFAULT_AUTHORIZATION_VALIDITY_MS,
                DEFAULT_REAUTHORIZATION_VALIDITY_MS, DEFAULT_REAUTHORIZATION_NOP_DUATION_MS);
    }
