...
- `reflector_unique_id` is a URL encoded 32 byte word generated securely at random by the reflector server
...
- `reflector_unique_id` is a unique 32 byte word generated by the WebSocket reflector server, as defined in the [reflector protocol](#reflector-protocol)
